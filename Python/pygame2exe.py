...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "ClockGame.py"
 
        #Name of program
        self.project_name = "Clock Game"
        ...
        self.license = "Clock Game License"
 
        #Auhor of program
        self.author_name = "Michael McCain"
        self.author_email = "mccaintrain@gmail.com.com"
        self.copyright = "Copyright (c) 2013 BYU Neuromechanics Lab."
